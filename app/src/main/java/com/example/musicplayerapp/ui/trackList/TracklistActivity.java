...
public class TracklistActivity extends AbstractActivity implements TracklistView, NavigationView.OnNavigationItemSelectedListener,
    ...
    @BindView(R.id.imageButton_playingRightNow_playPause)
    ImageButton playPauseButton;
    @BindView(R.id.imageView_currentSong_album_art)
    ImageView currentSongThumbnail;
    @BindView(R.id.seekBar_currentSong)
    SeekBar musicSeekBar;
    @BindView(R.id.recyclerView_trackList)
    RecyclerView recyclerView;
    @BindView(R.id.fastscroll)
    FastScroller fastScroller;
    @BindView(R.id.textView_currentSong_artist)
    TextView currentSongArtist;
    @BindView(R.id.textView_currentSong_title)
    TextView currentSongTitle;
    @BindView(R.id.relativeLayout_playingRightNow)
    RelativeLayout playingRightNowView;
